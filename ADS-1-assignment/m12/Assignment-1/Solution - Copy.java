...
class Interview {
    ...
    public void recruit(Student[] studentsSorted, int unreserved, int bc_category_vacancies, int st_category_vacancies, int sc_category_vacancies) {
        ...
        //         this.students[size++] = studentsSorted[count];
        //         unreserved--;
        //     } else if(bc_category_vacancies > 0) {
        //         if(studentsSorted[count].reservation_category.equals("BC")) {
        //             this.students[size++] = studentsSorted[count];
        //             bc_category_vacancies--;
        //         }
        //     } else if(st_category_vacancies > 0) {
        //         if(studentsSorted[count].reservation_category.equals("ST")) {
        //             this.students[size++] = studentsSorted[count];
        //             st_category_vacancies--;
        //         }
        //     } else if(sc_category_vacancies > 0) {
        //         if(studentsSorted[count].reservation_category.equals("SC")) {
        //             this.students[size++] = studentsSorted[count];
        //             sc_category_vacancies--;
        //         }
        //     }
        //     if(size == this.students.length) {
        //         break;
